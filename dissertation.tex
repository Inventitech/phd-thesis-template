...
%\usepackage[table]{xcolor} % for colouring tables and cells
...
\graphicspath{{figs/},{travis-analysis/figs/},{watchdog-tse/figs/}}
...
\bibliography{dissertation,./watchdog-tse/paper,./travis-analysis/structure}
