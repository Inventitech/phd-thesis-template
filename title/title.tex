...
\begin{tabular}{p{3.6cm}l}
    ...
    \multicolumn{2}{l}{Prof. Dr. D. Spinellis has contributed to the end phase of \Cref{chp:debugging}.} \\
\end{tabular}
...
\begin{tabular}{@{}p{0.2\textwidth}@{}p{0.8\textwidth}}
    ...
    \textit{Front \& Back:} & Beautiful cover art that captures the entire content of this thesis
    in a single illustration. \\[\medskipamount]
\end{tabular}
