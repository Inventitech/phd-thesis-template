...
\begin{tabular}{@{}p{0.2\textwidth}@{}p{0.8\textwidth}}
  \textit{Keywords:} & Feedback-Driven Development (FDD), Developer Testing, Empirical Software Engineering, Continuous Integration \\[\medskipamount]
      \textit{Printed by:} & ProefschriftMaken, \url{www.proefschriftmaken.nl} \\[\medskipamount]
    \textit{Cover:} & Cloud of 2,443 points by Zsófia Varga, in Giant Propel Advanced color \\[\medskipamount]
\end{tabular}
